...
CREATE TABLE `fare_attributes` (
  ...
  transfers INT(11),
  youth_price DECIMAL(9,6),
  senior_price DECIMAL(9,6),
...
CREATE TABLE `stop_times` (
  ...
  min_arrival_time VARCHAR(8),
  start_pickup_dropoff_window VARCHAR(255),
  max_departure_time VARCHAR(8),
  end_pickup_dropoff_window VARCHAR(255),
  timepoint TINYINT(1),
  ...
  continuous_pickup INT(2),
  continuous_drop_off INT(2),
  start_service_area_radius VARCHAR(255),
  end_service_area_radius VARCHAR(255),
  departure_buffer VARCHAR(255),
  mean_duration_factor VARCHAR(255),
  mean_duration_offset VARCHAR(255),
  safe_duration_factor VARCHAR(255),
  safe_duration_offset VARCHAR(255),
--   shape_dist_traveled DECIMAL(9,6),
...
--   trip_short_name VARCHAR(255),
  ...
  shape_id VARCHAR(255),
  drt_advance_book_min VARCHAR(255),
  peak_offpeak VARCHAR(255),
...
LOAD DATA LOCAL INFILE 'feed_info.txt' INTO TABLE feed_info FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' IGNORE 1 LINES;
